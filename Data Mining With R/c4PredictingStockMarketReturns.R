...
# Date  : Aug 5 2013
#
# Project: Predicting Stock Market Returns
#
#--------------------------------------------------------------------------#
# Loading Data Into R
#----------------------#
...
library(xts)
x1 <- xts(rnorm(100), seq(as.POSIXct("2000-01-01"), 
				      len = 100,
				      by = "day"))
x1[1:5]
...
mts <- xts(mts.vals,as.POSIXct(c('2003-01-01',
						         '2003-01-04',
						         '2003-01-05',
								 '2003-01-06',
								 '2003-02-16')))
...
#--------------------------------------------------------------------------#
# The Prediction Models - Artificial Neural Networks
#----------------------#

set.seed(1234)
library(nnet)
norm.data <- scale(Tdata.train)
nn <- nnet(Tform, norm.data[1:1000, ], 
		          size = 10, 
				  decay = 0.01,
		          maxit = 1000, 
				  linout = T, 
...
nn <- nnet(signals ~ ., norm.data[1:1000, ], 
		                size = 10, 
						decay = 0.01,
		                maxit = 1000, 
						trace = F)
...
#--------------------------------------------------------------------------#
# The Prediction Models - Support Vector Machines (regression & classification)
#----------------------#
...
#--------------------------------------------------------------------------#
# The Prediction Models - Multivariate Adaptive Regression Splines
#----------------------#
