...
alage <- read.csv('http://archive.ics.uci.edu/ml/machine-learning-databases/coil-mld/analysis.data',
		header=F,
		dec='.',
		col.names=c('season','size','speed','mxPH',
...
# Input values to missing observations
...
#--------------------------------------------------------------------------#
# Obtaining Prediction Models - Multiple Linear Regression (No missing values)
#----------------------#	
...
#--------------------------------------------------------------------------#
# Obtaining Prediction Models - Regression Trees (with missing values)
#----------------------#	
